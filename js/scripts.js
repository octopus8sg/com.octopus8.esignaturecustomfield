...
//sketch lib
    ...
    (function ($) {
        jQuery.fn.SignaturePad = function (options) {
            ...
            //add a very big pad
            // alert(JSON.stringify(big_pad));
            var big_pad = $('#signPadBig' + id);
            ...
            if (big_pad.length == 0) {
                ...
                back_drop.css('z-index', '10140 !important');
                ...
                canvas.css('z-index', '1030 !important');
                //canvas.css('width', '90%');
                ...
                var buttons = [
                    ...
                    btn.css('float', 'right');
                    btn.css('height', '40px');
                    btn.css('z-index', '1030 !important');
                    btn.text(e.title);
            ...
            return this.each(function () {
                ...
                img.css('z-index', '1030 !important');
                ...
                $.data(big_pad[0], 'img', null);
                $.data(big_pad[0], 'control', null);
                ...
                if (settings.allowToSign == true) {
                    ...
                    img.on('click', function () {
                        ...
                        // alert(big_pad.length);
                        id = 0;
                        $.data(big_pad[id], 'img', img);
                        $.data(big_pad[id], 'control', control);
...
CRM.$(function ($) {
    $(document).ready(function ($) {
        $('[class^=eSignature]').each(function (index) {
            ...
            // alert('signaturePad')
            var d = new Date();
            var signid = d.getTime();
            var img64 = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7';
            if(String($(this).val()).indexOf("data:image")>=0){
                img64 = $(this).val();
            }
            var signaturePad =  jQuery(this).SignaturePad({
                allowToSign: true,
                img64: img64,
                border: '1px solid #c7c8c9',
                width: '300px',
